...
export SERVICE_ACCOUNT_ID=$PROJECT

# 4.Assign different roles to the services account.

#dataflow
gcloud projects add-iam-policy-binding $PROJECT --member=serviceAccount:$SERVICE_ACCOUNT_ID@$PROJECT.iam.gserviceaccount.com --role=roles/dataflow.admin
gcloud projects add-iam-policy-binding $PROJECT --member=serviceAccount:$SERVICE_ACCOUNT_ID@$PROJECT.iam.gserviceaccount.com --role=roles/bigquery.admin
gcloud projects add-iam-policy-binding $PROJECT --member=serviceAccount:$SERVICE_ACCOUNT_ID@$PROJECT.iam.gserviceaccount.com --role=roles/datastore.user
...
#datastream
gcloud projects add-iam-policy-binding $PROJECT --member=serviceAccount:$SERVICE_ACCOUNT_ID@$PROJECT.iam.gserviceaccount.com --role=roles/storage.objectViewer
gcloud projects add-iam-policy-binding $PROJECT --member=serviceAccount:$SERVICE_ACCOUNT_ID@$PROJECT.iam.gserviceaccount.com --role=roles/storage.objectCreator
    
#cloud sql
gcloud projects add-iam-policy-binding $PROJECT --member=serviceAccount:$SERVICE_ACCOUNT_ID@$PROJECT.iam.gserviceaccount.com --role=roles/cloudsql.admin

#pub/sub
gcloud projects add-iam-policy-binding $PROJECT --member=serviceAccount:$SERVICE_ACCOUNT_ID@$PROJECT.iam.gserviceaccount.com --role=roles/pubsub.subscriber
gcloud projects add-iam-policy-binding $PROJECT --member=serviceAccount:$SERVICE_ACCOUNT_ID@$PROJECT.iam.gserviceaccount.com --role=roles/pubsub.admin
gcloud projects add-iam-policy-binding $PROJECT --member=serviceAccount:$SERVICE_ACCOUNT_ID@$PROJECT.iam.gserviceaccount.com --role=roles/pubsub.viewer

#5.Creating a service account key
gcloud iam service-accounts keys create key.json --iam-account=$SERVICE_ACCOUNT_ID@$PROJECT.iam.gserviceaccount.com
...
gsutil cp final_demo/data/* gs://$PROJECT/data/batch_data/
gsutil cp final_demo/ddl/* gs://$PROJECT/ddl/
...
gsutil iam ch serviceAccount:$SERVICE_ACCOUNT:objectViewer gs://$PROJECT
gcloud sql import sql ${MYSQL_INSTANCE} gs://$PROJECT/ddl/create-ds-user-privileges.sql --quiet

#17.Create table in mysql
gcloud sql import sql ${MYSQL_INSTANCE} gs://$PROJECT/ddl/ddl_user_activity.sql --quiet
...
gsutil notification create -f "json" -p "${DS_DIR_PATH}" -t "${DS_PUBSUB_TOPIC}" "gs://$PROJECT"
...
gcloud datastream connection-profiles create ${GCS_CONN_PROFILE} --location=${LOCATION} --type=google-cloud-storage --bucket=$PROJECT --root-path=${GCS_DS_PATH_PREFIX} --display-name=${GCS_CONN_PROFILE}
...
--region=us-west1 \
--staging_location=gs://$PROJECT/data/staging \
--temp_location=gs://$PROJECT/data/temp \
--project=$PROJECT \
--input-bucket=gs://$PROJECT/ \
